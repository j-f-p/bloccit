...
RSpec.describe PostsController, type: :controller do
  let(:my_user) { User.create!(name: "Bloccit User",
    email: "user@bloccit.com", password: "helloworld") }
  ...
  context "guest user" do
    ...
    describe "POST create" do
      it "returns http redirect" do
        post :create, params: { topic_id: my_topic.id, post: {
    ...
    describe "PUT update" do
      it "returns http redirect" do
        ...
        put :update, params: { topic_id: my_topic.id, id: my_post.id,
    ...
    describe "POST create" do
      it "increases the number of Post by 1" do
        expect{ post :create, params: { topic_id: my_topic.id,
          post: { title: RandomData.random_sentence,
